...
import { ArrowLeft, Clock, FileText, MessageCircle, Printer } from "lucide-react";
          ...
          <>
            ...
            <div className="grid grid-cols-4 gap-2 mb-4">
              {[
                ...
                { label: "Half Day", value: halfDay, color: "#E65100" },
                { label: "Absent", value: absent, color: "#C62828" },
                { label: "Total", value: attendance.length, color: "#1565C0" },
